            ...
            <div class="mb-3">
              ...
              >
                ...
                <option
                  ...
                  :disabled="!question.option1"
                >
                  Option 1: {{ question.option1 }}
                </option>
                <option
                  :value="question.option2"
                  :disabled="!question.option2"
                >
                  Option 2: {{ question.option2 }}
                </option>
                <option
                  :value="question.option3"
                  :disabled="!question.option3"
                >
                  Option 3: {{ question.option3 }}
                </option>
                <option
                  :value="question.option4"
                  :disabled="!question.option4"
                >
...
/* keep the card itself white */
.edit-question-page .card,
.edit-question-page .card-body {
